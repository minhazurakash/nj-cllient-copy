    ...
    <div className="bg-[#F5F2EC]">
          ...
          return (
            <>
              <div className="bg-white rounded-lg shadow-lg">
                <div className="flex flex-col items-center text-center p-10 h-[200px] bg-[#fcf9f4] ">
      ...
      <div className="bg-white rounded-lg shadow-lg">
                <div className="flex flex-col items-center text-center p-10 h-[200px] bg-[#fcf9f4] ">
                  ...
                  <div className="flex items-center">
                    <span className="text-xl pt-5  text-[#a59167]">Make Your Own Plan</span>
                  </div>
                </div>
                <div className="p-10">
            ...
            <div className={`w-96 ${showModal ? 'block' : 'hidden'} transition-all duration-500`}>
              <div className="fixed z-[100] inset-0 overflow-y-auto">
                <div className="flex flex-col items-center justify-center min-h-screen bg-[#f3e8e4c7]">
                  ...
                  <div className="w-full  text-center max-w-lg px-6 py-10 bg-white rounded-lg shadow-lg">
                    <p className="text-2xl font-bold mb-8 text-gray-800">For custom package, please contact us 
                    <br /><br />
