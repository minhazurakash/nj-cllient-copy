            ...
            <div className={`w-96 ${showModal ? 'block' : 'hidden'} transition-all duration-500`}>
              <div className="fixed z-[100] inset-0 overflow-y-auto">
                <div className="flex flex-col items-center justify-center min-h-screen bg-[#f3e8e4c7]">
                  ...
                  <div className="w-full  text-center max-w-md px-6 py-10 bg-white rounded-lg shadow-lg">
                    <p className="text-2xl font-bold mb-8 text-gray-800">For custom package, please contact us and we will be happy to assist you</p>
                    <button
                          type="button"
                          onClick={handleClose}
