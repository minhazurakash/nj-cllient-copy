        ...
        <div className="grid  md:lg:xl:grid-cols-3 text-center grid-cols-1 gap-8 ">
          ...
          <div className='text-[#ae9d78] text-center'>
            ...
            <div className="flex mt-4 space-x-6 justify-center sm:mt-0">
              ...
              <a href={contentData.instagram} target="_blank" className="text-gray-500 hover:text-[#ae9d78] " rel="noreferrer">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href={contentData.github} target="_blank" className="text-gray-500 hover:text-[#ae9d78] " rel="noreferrer">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href={contentData.linkdin} target="_blank" className="text-gray-500 hover:text-[#ae9d78] " rel="noreferrer">
