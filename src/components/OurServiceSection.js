...
const OurServiceSection = () => {
  return (
    ...
    <div className="container mx-auto  my-20">
      ...
      <div className="grid grid-cols-8 lg:xl:px-[120px] items-center gap-8 lg:gap-5">
        ...
        <div className="md:order-1 col-span-8 md:col-span-5">
          <h2 className="text-3xl mb-3 mb-8 text-4xl font-subtitle">These are the facts:</h2>
          <p className=" leading-relaxed mb-5 text-xl font-subtitle">

            <span className="font-bold">  “Organic vs. Paid Search Results: Organic Wins 94% of Time”</span>- <a href="http://searchenginewatch.com/sew/news/2200730/organic-vs-paid-search-results-organic-wins-94-of-time" className="underline decoration-[#333] text-[#333] font-bold">Search Engine Watch</a>  <br />
            ...
            <a href="https://www.pewresearch.org/search/91%25+of+Internet+users+search+for+purchasing+information+every+month./" className="underline decoration-[#333] text-[#333] font-bold">
              Pew Research </a>
            <br /><br />
            <span className="font-bold">
              “The top 5 results get 75% of the clicks!” </span>-
            <a href="https://blog.hubspot.com/insiders/seo-facts" className="underline decoration-[#333] text-[#333] font-bold">
            ...
            <br /><br />
            <span className="font-bold">
              “82 percent of the purchases made online, started with a search entry.”</span> – <a href="https://www.mckinsey.com/~/media/mckinsey/dotcom/client_service/high%20tech/pdfs/impact_of_internet_technologies_search_final2.ashx" className="underline decoration-[#333] text-[#333] font-bold">McKinsey & Company</a>
            <br /><br />
            


          </p>
          {/* <button className="lg:xl:px-[120px] py-2 uppercase bg-[#FFF79E] hover:bg-[#EDCF55]">
            SEE our service
          </button> */}
        </div>
<div className="md:order-3 col-span-8 md:col-span-8">
        ...
        <div className="md:order-4 col-span-8 md:col-span-8">
          <p className="leadeing-relaxed text-justify font-subtitle text-xl">
